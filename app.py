...
if not st.session_state.logged_in:
    ...
    if menu == "🏠 홈":
        ...
        with st.container():
            ...
            with col1:
                st.image("https://images.unsplash.com/photo-1517191434949-5e90cd67d2b6?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDJ8NnNNVmpUTFNrZVF8fGVufDB8fHx8fA%3D%3D", width=50)
            with col2:
